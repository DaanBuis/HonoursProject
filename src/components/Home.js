...
const Home = () => {
    return (
        <div>
            ...
            <p className="px-4 pt-1">You can click <a href="/chapter1-intro">here</a> to get started straight away, or you can use the <a href="/chapters">Chapters</a> page to navigate to the different topics.</p>
            <p className="px-4 pt-1">If you have any questions or inqueries, please either see the <a href="/about">about us</a> page, or email DBUIS201@caledonian.ac.uk</p>
        </div>
    )
}
